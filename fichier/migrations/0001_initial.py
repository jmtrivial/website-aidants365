    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('titre_fiche', models.CharField(default='titre', max_length=256, verbose_name='Titre de la fiche')),
                ...
                ('reserves', models.CharField(blank=True, max_length=1024, verbose_name='Réserves')),
                ('lesplus', models.CharField(blank=True, max_length=1024, verbose_name='Les plus')),
                ('en_savoir_plus', models.CharField(blank=True, max_length=1024, verbose_name='En savoir plus')),
