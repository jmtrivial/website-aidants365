...
urlpatterns = [
    ...
    path('categories_libres/', views.categories_libres, name='categories_libres'),
    path('categories_libres/alpha/', views.categories_libres_alpha, name='categories_libres_alpha'),
    path('categories_libres/nuage/', views.categories_libres_nuage, name='categories_libres_nuage'),
